...
pub const VC4_PACKET_NOP_SIZE: usize =1;
pub const VC4_PACKET_FLUSH_SIZE: usize =1;
pub const VC4_PACKET_FLUSH_ALL_SIZE: usize =1;
pub const VC4_PACKET_START_TILE_BINNING_SIZE: usize =1;
pub const VC4_PACKET_INCREMENT_SEMAPHORE_SIZE: usize =1;
pub const VC4_PACKET_WAIT_ON_SEMAPHORE_SIZE: usize =1;
pub const VC4_PACKET_BRANCH_SIZE: usize =5;
pub const VC4_PACKET_BRANCH_TO_SUB_LIST_SIZE: usize =5;
pub const VC4_PACKET_STORE_MS_TILE_BUFFER_SIZE: usize =1;
pub const VC4_PACKET_STORE_MS_TILE_BUFFER_AND_EOF_SIZE: usize =1;
pub const VC4_PACKET_STORE_FULL_RES_TILE_BUFFER_SIZE: usize =5;
pub const VC4_PACKET_LOAD_FULL_RES_TILE_BUFFER_SIZE: usize =5;
pub const VC4_PACKET_STORE_TILE_BUFFER_GENERAL_SIZE: usize =7;
pub const VC4_PACKET_LOAD_TILE_BUFFER_GENERAL_SIZE: usize =7;
pub const VC4_PACKET_GL_INDEXED_PRIMITIVE_SIZE: usize =14;
pub const VC4_PACKET_GL_ARRAY_PRIMITIVE_SIZE: usize =10;
pub const VC4_PACKET_COMPRESSED_PRIMITIVE_SIZE: usize =1;
pub const VC4_PACKET_CLIPPED_COMPRESSED_PRIMITIVE_SIZE: usize =1;
pub const VC4_PACKET_PRIMITIVE_LIST_FORMAT_SIZE: usize =2;
pub const VC4_PACKET_GL_SHADER_STATE_SIZE: usize =5;
pub const VC4_PACKET_NV_SHADER_STATE_SIZE: usize =5;
pub const VC4_PACKET_VG_SHADER_STATE_SIZE: usize =5;
pub const VC4_PACKET_CONFIGURATION_BITS_SIZE: usize =4;
pub const VC4_PACKET_FLAT_SHADE_FLAGS_SIZE: usize =5;
pub const VC4_PACKET_POINT_SIZE_SIZE: usize =5;
pub const VC4_PACKET_LINE_WIDTH_SIZE: usize =5;
pub const VC4_PACKET_RHT_X_BOUNDARY_SIZE: usize =3;
pub const VC4_PACKET_DEPTH_OFFSET_SIZE: usize =5;
pub const VC4_PACKET_CLIP_WINDOW_SIZE: usize =9;
pub const VC4_PACKET_VIEWPORT_OFFSET_SIZE: usize =5;
pub const VC4_PACKET_Z_CLIPPING_SIZE: usize =9;
pub const VC4_PACKET_CLIPPER_XY_SCALING_SIZE: usize =9;
pub const VC4_PACKET_CLIPPER_Z_SCALING_SIZE: usize =9;
pub const VC4_PACKET_TILE_BINNING_MODE_CONFIG_SIZE: usize =16;
pub const VC4_PACKET_TILE_RENDERING_MODE_CONFIG_SIZE: usize =11;
pub const VC4_PACKET_CLEAR_COLORS_SIZE: usize =14;
pub const VC4_PACKET_TILE_COORDINATES_SIZE: usize =3;
pub const VC4_PACKET_GEM_HANDLES_SIZE: usize =9;
...
pub const VC4_BIN_CONFIG_ALLOC_BLOCK_SIZE_MASK: u8 = (1 << ((6) - (5) + 1) - 1) << (5);
...
pub const VC4_BIN_CONFIG_ALLOC_INIT_BLOCK_SIZE_MASK : usize = (1 << ((4) - (3) + 1) - 1) << (3);
pub const VC4_BIN_CONFIG_ALLOC_INIT_BLOCK_SIZE_SHIFT : usize =3;
pub const VC4_BIN_CONFIG_ALLOC_INIT_BLOCK_SIZE_32    : usize =0;
pub const VC4_BIN_CONFIG_ALLOC_INIT_BLOCK_SIZE_64    : usize =1;
pub const VC4_BIN_CONFIG_ALLOC_INIT_BLOCK_SIZE_128   : usize =2;
pub const VC4_BIN_CONFIG_ALLOC_INIT_BLOCK_SIZE_256   : usize =3;

pub const VC4_BIN_CONFIG_AUTO_INIT_TSDA: usize =BIT(2);
pub const VC4_BIN_CONFIG_TILE_BUFFER_64BIT: usize =BIT(1);
pub const VC4_BIN_CONFIG_MS_MODE_4X: usize =BIT(0);
// /** @} */
